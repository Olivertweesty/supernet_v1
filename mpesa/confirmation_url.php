...
$sql = "INSERT INTO mpesa_records(id,transactiontype, transID, transtime, transAmount, businessShortCode, invoiceNumber, OrgAccountBalance, MSISDN, FirstName, LastName) VALUES ('','$type','$transID','$n_time','$TransAmount','$BusinessShortCode','$BillRefNumber','$OrgAccountBalance','$MSISDN','$FirstName','$LastName')";
