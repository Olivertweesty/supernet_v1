...
if(isset($_POST['update']))
{
    ...
    $ddate=$_POST['ddate'];
$userid=$_GET['uid'];
    $msg=mysqli_query($con,"update users set fname='$fname',lname='$lname',contactno='$contact',package='$package',charge='$charge',due_date='$ddate' where id='$userid'");
                     ...
                     <form method="post">
                            <div class="card-body">
                                <table class="table table-bordered">
                                   ...
                                   <tr>
                                       <th>Speed.</th>
                                       <td><input class="form-control" id="package1" name="package1" type="text" value="<?php echo $result['package'];?>"  required /></td>
                                   </tr>
                                   <tr>
                                       <th>Due Date</th>
                                       <td><input class="form-control" id="ddate" name="ddate" type="date" value="<?php echo $result['due_date'];?>"  required /></td>
                                   </tr>
                                   <tr>
                                       <th>Charge.</th>
                                       <td><input class="form-control" id="charge1" name="charge1" type="text" value="<?php echo $result['charge'];?>"  required /></td>
                                   </tr>
                                   <tr>
                                       <th>Email</th>
